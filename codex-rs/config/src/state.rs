...
pub struct ConfigLayerStack {
    ...
    /// the base `$CODEX_AKRAM_HOME/config.toml` layer followed by the profile override
...
impl ConfigLayerStack {
    ...
    /// the base `$CODEX_AKRAM_HOME/config.toml` layer because the active layer is the
