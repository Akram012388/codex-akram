...
#[derive(Debug, Parser)]
#[command(bin_name = "codex-akram plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-akram plugin add",
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-akram plugin list",
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-akram plugin remove",
...
fn is_implicit_system_marketplace_root(
    ...
    marketplace_name == OPENAI_PRIMARY_RUNTIME_MARKETPLACE_NAME
        && path_ends_with(
            root,
            &[
                codex_akram_identity::RUNTIME_CACHE_DIR,
