...
/// Expected structure for $CODEX_AKRAM_HOME/auth.json.
...
impl FileAuthStorage {
    ...
    /// Attempt to read and parse the `auth.json` file in the given `CODEX_AKRAM_HOME` directory.
...
const KEYRING_SERVICE: &str = codex_akram_identity::AUTH_KEYRING_SERVICE;
